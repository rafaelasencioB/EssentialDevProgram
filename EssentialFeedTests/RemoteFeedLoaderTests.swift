...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversItemsOn200HTTPResponseWithJSONItems() {
        ...
        let item1 = FeedItem(id: UUID(), description: nil, location: nil, imageURL: URL(string: "any-URL.com")!)
        ...
        let item2 = FeedItem(id: UUID(), description: "a description", location: "a location", imageURL: URL(string: "any-URL.com")!)
